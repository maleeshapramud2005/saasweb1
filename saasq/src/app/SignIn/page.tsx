    ...
    return(
        <div className="bg-gray-100 min-h-screen flex items-center justify-center">
            <div className="max-w-md w-full p-8 bg-white shadow-lg rounded-lg mb-5">
                ...
                <p className="mb-8">use the form below to access your account</p>
                <form>
                    ...
                    <div className="mb-6 py-2">
                        <label className="w-12 ">Forgot Password ?</label><button type="submit" className="w-1/2 bg-blue-800 text-white py-3 px-4 rounded-full float-right hover:bg-blue-600 focus:outline-none focus:bg-blue-600">Sign In</button>
                    </div>
                </form>
                ...
                <div className="max-w-md py-2">
                        <label className="w-12 ">Don't have account ?</label><label htmlFor="" className="ml-12 text-blue-500 hover:text-blue-700"><a href="./Signup">Sign Up</a></label>
                    </div>
            </div>
        </div>
    );
